"""Base module for queue providers in AIMQ.

This module defines the core interfaces and base classes for implementing queue
providers. It includes the base QueueProvider abstract class that all queue
implementations must extend, and common exceptions and types used across queue
implementations.
"""
