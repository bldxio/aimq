"""Migration management for Supabase AIMQ integration.

This module provides functionality for creating and managing database migrations
for AIMQ integration with Supabase, including queue setup and configuration.
"""
...
class SupabaseMigrations:
    """Manages Supabase database migrations for AIMQ integration.

    This class handles the creation and management of SQL migration files
    for setting up AIMQ queues and required database configurations in Supabase.
    """
