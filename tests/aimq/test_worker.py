...
This module contains test cases for the Worker and WorkerThread classes,
including task management, queue operations, and error handling functionality.
"""
...
def mock_logger():
    ...
    Returns:
        Mock: A mock logger instance with print method.
    """
...
def worker(mock_logger):
    ...
    Returns:
        Worker: A worker instance configured with the mock logger.
    """
    worker = Worker()
