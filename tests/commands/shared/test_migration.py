"""Tests for the migration functionality in the shared commands package."""
...
def test_create_migration_new(
    migrations: SupabaseMigrations, project_path: Mock
) -> None:
    """
    ...
    project_path.migration_path.return_value = Path(
        "/test/migrations/test_migration.sql"
    )
    ...
    with (
        ...
        mock_makedirs.assert_called_once_with(
            migrations.project_path.migrations, exist_ok=True
        )
...
def test_create_migration_existing(
    migrations: SupabaseMigrations, project_path: Mock
) -> None:
    """
...
def test_setup_aimq_migration(migrations: SupabaseMigrations) -> None:
    ...
    with patch.object(migrations, "create_migration") as mock_create:
        ...
        mock_create.assert_called_once_with(
            name="setup_aimq", template_name="setup_aimq.sql"
        )
