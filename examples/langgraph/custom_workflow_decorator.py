...
if __name__ == "__main__":
    print("=" * 60)
    print("Custom Workflow - ETL Pipeline")
    print("=" * 60)
    print("\nConfiguration:")
    print("  Queue: etl-pipeline")
    print("  Timeout: 600s (10 minutes)")
    print("  Checkpointing: Enabled")
    print("  State: Custom ETLState")

    print("\n" + "-" * 60)
    print("Workflow Steps")
    print("-" * 60)
    print("  1. extract   - Read data from source file")
    print("  2. transform - Apply business transformations")
    print("  3. load      - Store results in database")

    print("\n" + "-" * 60)
    print("State Structure")
    print("-" * 60)
    print("  Required fields:")
    print("    - source_path: str")
    print("    - load_status: str")
    print("    - errors: list[str] (accumulates)")
    ...
    print("\n1. Process CSV file:")
    print("   aimq send etl-pipeline '{")
    print('     "source_path": "data/sales_2024.csv",')
    print('     "load_status": "",')
    print('     "errors": []')
    print("   }'")
    ...
    print("\n2. Process JSON data:")
    print("   aimq send etl-pipeline '{")
    print('     "source_path": "exports/user_data.json",')
    print('     "load_status": "",')
    print('     "errors": []')
    print("   }'")
    ...
    print("\n3. Process text file:")
    print("   aimq send etl-pipeline '{")
    print('     "source_path": "logs/application.log",')
    print('     "load_status": "",')
    print('     "errors": []')
    print("   }'")
    ...
    print("   aimq send etl-pipeline '{")
    print('     "source_path": "large_files/yearly_data.csv",')
    print('     "thread_id": "etl-batch-2024-10",')
    print('     "load_status": "",')
    print('     "errors": []')
    print("   }'")
    ...
    print("-" * 60)
    print("  Errors accumulate in state['errors'] using the add reducer.")
    print("  This allows all steps to report errors without overwriting.")
    print("  Final state contains complete error history for debugging.")

    print("\n" + "-" * 60)
    print("Decorator Benefits")
    print("-" * 60)
    print("  - Custom state definition (ETLState)")
    print("  - Type safety with TypedDict")
    print("  - Automatic checkpointing")
    print("  - Error accumulation pattern")
    print("  - Clean separation of extract/transform/load logic")
